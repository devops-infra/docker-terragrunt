...
For example:
 * `docker-terragrunt:tf-0.14.8-tg-0.28.9` means it's Terraform v0.14.8 and Terragrunt v0.28.9 without additional CLI.
 * `docker-terragrunt:aws-tf-0.14.8-tg-0.28.9` means it's Terraform v0.14.8 and Terragrunt v0.28.9 with AWS CLI.
...
| ------------------------------------------------------------------------------------------------ | -------- | ----------------- | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `devopsinfra/docker-terragrunt:tf-0.14.8-tg-0.28.9`                                              | Docker   | v0.14.8           | v0.28.9            | N/A                                                                                                                                                                                                                                           |
| `docker.pkg.github.com/devops-infra/docker-terragrunt/docker-terragrunt:tf-0.14.8-tg-0.28.9`     | GitHub   | v0.14.8           | v0.28.9            | N/A                                                                                                                                                                                                                                           |
| `devopsinfra/docker-terragrunt:aws-tf-0.14.8-tg-0.28.9`                                          | Docker   | v0.14.8           | v0.28.9            | [awscli](https://github.com/aws/aws-cli) - For interacting with AWS infrastructure, e.g. for publishing Lambda packages to S3.<br>[boto3](https://github.com/boto/boto3) - Python library for interacting with AWS infrastructure in scripts. |
| `docker.pkg.github.com/devops-infra/docker-terragrunt/docker-terragrunt:aws-tf-0.14.8-tg-0.28.9` | GitHub   | v0.14.8           | v0.28.9            | [awscli](https://github.com/aws/aws-cli) - For interacting with AWS infrastructure, e.g. for publishing Lambda packages to S3.<br>[boto3](https://github.com/boto/boto3) - Python library for interacting with AWS infrastructure in scripts. |
