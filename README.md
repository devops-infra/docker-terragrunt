...
<br>
For example:
 * `devopsinfra/docker-terragrunt:tf-0.12.24-tg-0.23.17` means it's Terraform v0.12.24 and Terragrunt v0.23.17 without additional CLI.
 * `devopsinfra/docker-terragrunt:aws-tf-0.12.24-tg-0.23.17` means it's Terraform v0.12.24 and Terragrunt v0.23.17 with AWS CLI.
...
:--- | :--- | :--- | :---
`devopsinfra/docker-terragrunt:latest`<br>`devopsinfra/docker-terragrunt:tf-0.12.24-tg-0.23.17` |  v0.12.24 | v0.23.17 | N/A
`devopsinfra/docker-terragrunt:aws-latest`<br>`devopsinfra/docker-terragrunt:aws-tf-0.12.24-tg-0.23.17` |  v0.12.24 | v0.23.17 | [awscli](https://github.com/aws/aws-cli) - For interacting with AWS infrastructure, e.g. for publishing Lambda packages to S3.<br>[boto3](https://github.com/boto/boto3) - Python library for interacting with AWS infrastructure in scripts.
