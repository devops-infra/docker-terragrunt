...
<br>
For example:
 * `devopsinfra/docker-terragrunt:tf-0.14.6-tg-0.28.2` means it's Terraform v0.14.6 and Terragrunt v0.28.2 without additional CLI.
 * `devopsinfra/docker-terragrunt:aws-tf-0.14.6-tg-0.28.2` means it's Terraform v0.14.6 and Terragrunt v0.28.2 with AWS CLI.
...
| ----------------------------------------------------------------------------------------------------- | ----------------- | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `devopsinfra/docker-terragrunt:latest`<br>`devopsinfra/docker-terragrunt:tf-0.14.6-tg-0.28.2`         | v0.14.6           | v0.28.2            | N/A                                                                                                                                                                                                                                           |
| `devopsinfra/docker-terragrunt:aws-latest`<br>`devopsinfra/docker-terragrunt:aws-tf-0.14.6-tg-0.28.2` | v0.14.6           | v0.28.2            | [awscli](https://github.com/aws/aws-cli) - For interacting with AWS infrastructure, e.g. for publishing Lambda packages to S3.<br>[boto3](https://github.com/boto/boto3) - Python library for interacting with AWS infrastructure in scripts. |
