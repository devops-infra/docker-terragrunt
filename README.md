...
<br>
For example:
 * `devopsinfra/docker-terragrunt:tf-0.12.26-tg-0.23.28` means it's Terraform v0.12.26 and Terragrunt v0.23.28 without additional CLI.
 * `devopsinfra/docker-terragrunt:aws-tf-0.12.26-tg-0.23.28` means it's Terraform v0.12.26 and Terragrunt v0.23.28 with AWS CLI.
...
:--- | :--- | :--- | :---
`devopsinfra/docker-terragrunt:latest`<br>`devopsinfra/docker-terragrunt:tf-0.12.26-tg-0.23.28` |  v0.12.26 | v0.23.28 | N/A
`devopsinfra/docker-terragrunt:aws-latest`<br>`devopsinfra/docker-terragrunt:aws-tf-0.12.26-tg-0.23.28` |  v0.12.26 | v0.23.28 | [awscli](https://github.com/aws/aws-cli) - For interacting with AWS infrastructure, e.g. for publishing Lambda packages to S3.<br>[boto3](https://github.com/boto/boto3) - Python library for interacting with AWS infrastructure in scripts.
