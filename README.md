...
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:ot-1.12.5-tg-1.1.1`                            | `docker-terragrunt` | `ot-1.12.5-tg-1.1.1` | `N/A`             | `1.12.5`         | `1.1.1`            |
...
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:ot-1.12.5-tg-1.1.1` | `docker-terragrunt` | `ot-1.12.5-tg-1.1.1` | `N/A`             | `1.12.5`         | `1.1.1`            |
