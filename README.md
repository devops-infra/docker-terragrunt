...
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:ot-1.10.2-tg-0.82.3`                            | `docker-terragrunt` | `ot-1.10.2-tg-0.82.3` | `N/A`             | `1.10.2`          | `0.82.3`           |
...
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:ot-1.10.2-tg-0.82.3` | `docker-terragrunt` | `ot-1.10.2-tg-0.82.3` | `N/A`             | `1.10.2`          | `0.82.3`           |
