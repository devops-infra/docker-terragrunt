...
<br>
For example:
 * `christophshyper/docker-terragrunt:tf-0.12.21-tg-0.22.5` means it's Terraform v0.12.21 and Terragrunt v0.22.5 without additional CLI.
 * `christophshyper/docker-terragrunt:aws-tf-0.12.21-tg-0.22.5` means it's Terraform v0.12.21 and Terragrunt v0.22.5 with AWS CLI.
...
:--- | :--- | :--- | :---
`christophshyper/docker-terragrunt:latest`<br>`christophshyper/docker-terragrunt:tf-0.12.21-tg-0.22.5` |  v0.12.21 | v0.22.5 | N/A
`christophshyper/docker-terragrunt:aws-latest`<br>`christophshyper/docker-terragrunt:aws-tf-0.12.21-tg-0.22.5` |  v0.12.21 | v0.22.5 | [awscli](https://github.com/aws/aws-cli) - For interacting with AWS infrastructure, e.g. for publishing Lambda packages to S3.<br>[boto3](https://github.com/boto/boto3) - Python library for interacting with AWS infrastructure in scripts.
