...
|:---------------------------------------|
| `tf-1.12.2-ot-1.10.1-tg-0.82.3`         |


| Registry                                                                             | Example full image name                                                       | Image name          | Image version        | Terraform version | OpenTofu version | Terragrunt version |
|--------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|---------------------|----------------------|-------------------|------------------|--------------------|
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:tf-1.12.2-tg-0.82.3`                            | `docker-terragrunt` | `tf-1.12.2-tg-0.82.3` | `1.12.2`           | `N/A`            | `0.82.3`           |
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:ot-1.10.1-tg-0.82.3`                            | `docker-terragrunt` | `ot-1.10.1-tg-0.82.3` | `N/A`             | `1.10.1`          | `0.82.3`           |
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:tf-1.12.2-tg-0.82.3` | `docker-terragrunt` | `tf-1.12.2-tg-0.82.3` | `1.12.2`           | `N/A`            | `0.82.3`           |
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:ot-1.10.1-tg-0.82.3` | `docker-terragrunt` | `ot-1.10.1-tg-0.82.3` | `N/A`             | `1.10.1`          | `0.82.3`           |
