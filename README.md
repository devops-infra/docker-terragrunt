...
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:ot-1.11.3-tg-0.97.2`                            | `docker-terragrunt` | `ot-1.11.3-tg-0.97.2` | `N/A`             | `1.11.3`          | `0.97.2`           |
...
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:ot-1.11.3-tg-0.97.2` | `docker-terragrunt` | `ot-1.11.3-tg-0.97.2` | `N/A`             | `1.11.3`          | `0.97.2`           |
