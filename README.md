...
|:---------------------------------------|
| `tf-1.12.1-ot-1.9.1-tg-0.80.3`         |


| Registry                                                                             | Example full image name                                                       | Image name          | Image version        | Terraform version | OpenTofu version | Terragrunt version |
|--------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|---------------------|----------------------|-------------------|------------------|--------------------|
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:tf-1.12.1-tg-0.80.3`                            | `docker-terragrunt` | `tf-1.12.1-tg-0.80.3` | `1.12.1`           | `N/A`            | `0.80.3`           |
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:ot-1.9.1-tg-0.80.3`                            | `docker-terragrunt` | `ot-1.9.1-tg-0.80.3` | `N/A`             | `1.9.1`          | `0.80.3`           |
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:tf-1.12.1-tg-0.80.3` | `docker-terragrunt` | `tf-1.12.1-tg-0.80.3` | `1.12.1`           | `N/A`            | `0.80.3`           |
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:ot-1.9.1-tg-0.80.3` | `docker-terragrunt` | `ot-1.9.1-tg-0.80.3` | `N/A`             | `1.9.1`          | `0.80.3`           |
