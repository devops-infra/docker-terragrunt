...
|:---------------------------------------|
| `tf-1.15.7-ot-1.12.3-tg-1.1.0`         |


| Registry                                                                             | Example full image name                                                       | Image name          | Image version        | Terraform version | OpenTofu version | Terragrunt version |
|--------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|---------------------|----------------------|-------------------|------------------|--------------------|
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:tf-1.15.7-tg-1.1.0`                            | `docker-terragrunt` | `tf-1.15.7-tg-1.1.0` | `1.15.7`          | `N/A`            | `1.1.0`            |
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:ot-1.12.3-tg-1.1.0`                            | `docker-terragrunt` | `ot-1.12.3-tg-1.1.0` | `N/A`             | `1.12.3`         | `1.1.0`            |
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:tf-1.15.7-tg-1.1.0` | `docker-terragrunt` | `tf-1.15.7-tg-1.1.0` | `1.15.7`          | `N/A`            | `1.1.0`            |
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:ot-1.12.3-tg-1.1.0` | `docker-terragrunt` | `ot-1.12.3-tg-1.1.0` | `N/A`             | `1.12.3`         | `1.1.0`            |
