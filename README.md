...
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:ot-1.12.4-tg-1.1.0`                            | `docker-terragrunt` | `ot-1.12.4-tg-1.1.0` | `N/A`             | `1.12.4`         | `1.1.0`            |
...
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:ot-1.12.4-tg-1.1.0` | `docker-terragrunt` | `ot-1.12.4-tg-1.1.0` | `N/A`             | `1.12.4`         | `1.1.0`            |
