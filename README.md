...
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:ot-1.11.6-tg-1.0.0`                            | `docker-terragrunt` | `ot-1.11.6-tg-1.0.0` | `N/A`             | `1.11.6`         | `1.0.0`            |
...
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:ot-1.11.6-tg-1.0.0` | `docker-terragrunt` | `ot-1.11.6-tg-1.0.0` | `N/A`             | `1.11.6`         | `1.0.0`            |
