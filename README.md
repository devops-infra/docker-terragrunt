...
|:---------------------------------------|
| `tf-1.11.4-ot-1.9.0-tg-0.77.19`         |


| Registry                                                                             | Example full image name                                                       | Image name          | Image version        | Terraform version | OpenTofu version | Terragrunt version |
|--------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|---------------------|----------------------|-------------------|------------------|--------------------|
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:tf-1.11.4-tg-0.77.19`                            | `docker-terragrunt` | `tf-1.11.4-tg-0.77.19` | `1.11.4`           | `N/A`            | `0.77.19`           |
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:ot-1.9.0-tg-0.77.19`                            | `docker-terragrunt` | `ot-1.9.0-tg-0.77.19` | `N/A`             | `1.9.0`          | `0.77.19`           |
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:tf-1.11.4-tg-0.77.19` | `docker-terragrunt` | `tf-1.11.4-tg-0.77.19` | `1.11.4`           | `N/A`            | `0.77.19`           |
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:ot-1.9.0-tg-0.77.19` | `docker-terragrunt` | `ot-1.9.0-tg-0.77.19` | `N/A`             | `1.9.0`          | `0.77.19`           |
