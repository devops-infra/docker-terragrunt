...
|:---------------------------------------|
| `tf-1.15.5-ot-1.12.1-tg-1.0.7`         |


| Registry                                                                             | Example full image name                                                       | Image name          | Image version        | Terraform version | OpenTofu version | Terragrunt version |
|--------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|---------------------|----------------------|-------------------|------------------|--------------------|
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:tf-1.15.5-tg-1.0.7`                            | `docker-terragrunt` | `tf-1.15.5-tg-1.0.7` | `1.15.5`          | `N/A`            | `1.0.7`            |
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:ot-1.12.1-tg-1.0.7`                            | `docker-terragrunt` | `ot-1.12.1-tg-1.0.7` | `N/A`             | `1.12.1`         | `1.0.7`            |
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:tf-1.15.5-tg-1.0.7` | `docker-terragrunt` | `tf-1.15.5-tg-1.0.7` | `1.15.5`          | `N/A`            | `1.0.7`            |
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:ot-1.12.1-tg-1.0.7` | `docker-terragrunt` | `ot-1.12.1-tg-1.0.7` | `N/A`             | `1.12.1`         | `1.0.7`            |
