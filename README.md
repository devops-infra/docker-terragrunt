...
|:---------------------------------------|
| `tf-1.15.9-ot-1.12.6-tg-1.1.3`         |


| Registry                                                                             | Example full image name                                                       | Image name          | Image version        | Terraform version | OpenTofu version | Terragrunt version |
|--------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|---------------------|----------------------|-------------------|------------------|--------------------|
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:tf-1.15.9-tg-1.1.3`                            | `docker-terragrunt` | `tf-1.15.9-tg-1.1.3` | `1.15.9`          | `N/A`            | `1.1.3`            |
| [Docker Hub](https://hub.docker.com/repository/docker/devopsinfra/docker-terragrunt) | `devopsinfra/docker-terragrunt:ot-1.12.6-tg-1.1.3`                            | `docker-terragrunt` | `ot-1.12.6-tg-1.1.3` | `N/A`             | `1.12.6`         | `1.1.3`            |
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:tf-1.15.9-tg-1.1.3` | `docker-terragrunt` | `tf-1.15.9-tg-1.1.3` | `1.15.9`          | `N/A`            | `1.1.3`            |
| [GitHub Packages](https://github.com/devops-infra/docker-terragrunt/packages)        | `ghcr.io/devops-infra/docker-terragrunt/docker-terragrunt:ot-1.12.6-tg-1.1.3` | `docker-terragrunt` | `ot-1.12.6-tg-1.1.3` | `N/A`             | `1.12.6`         | `1.1.3`            |
