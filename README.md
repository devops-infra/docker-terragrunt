...
<br>
For example:
 * `devopsinfra/docker-terragrunt:tf-0.14.5-tg-0.27.1` means it's Terraform v0.14.5 and Terragrunt v0.27.1 without additional CLI.
 * `devopsinfra/docker-terragrunt:aws-tf-0.14.5-tg-0.27.1` means it's Terraform v0.14.5 and Terragrunt v0.27.1 with AWS CLI.
...
| ----------------------------------------------------------------------------------------------------- | ----------------- | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `devopsinfra/docker-terragrunt:latest`<br>`devopsinfra/docker-terragrunt:tf-0.14.5-tg-0.27.1`         | v0.14.5           | v0.27.1            | N/A                                                                                                                                                                                                                                           |
| `devopsinfra/docker-terragrunt:aws-latest`<br>`devopsinfra/docker-terragrunt:aws-tf-0.14.5-tg-0.27.1` | v0.14.5           | v0.27.1            | [awscli](https://github.com/aws/aws-cli) - For interacting with AWS infrastructure, e.g. for publishing Lambda packages to S3.<br>[boto3](https://github.com/boto/boto3) - Python library for interacting with AWS infrastructure in scripts. |
