...
| `0.11.0.68`  | latest stable `0.11.x` | latest stable `0.18.x` |
...
| `0.11.0.68-<tag>` | Tag: `<tag>`      | latest stable `0.11.x` during tag creation | latest stable `0.18.x` during tag creation |
